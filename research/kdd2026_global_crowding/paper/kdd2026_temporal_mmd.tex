...
\begin{enumerate}
    \item \textbf{Electricity}: Temporal-MMD (0.651) significantly outperforms all baselines ($p < 0.01$ vs RF, DANN, CDAN). This domain has the highest regime imbalance (33\% peak vs 67\% off-peak), validating our hypothesis that T-MMD helps most when regimes are imbalanced. The improvement of +7.1\% over RF is substantial for a domain adaptation task.
