...
\subsection{MMD-based domain adaptation}

\subsubsection{Algorithm E.2: MMD Domain Adaptation Training}

\textbf{Purpose}: Learn domain-invariant representations that transfer factor crowding insights from US to global markets.
...
MMD Transfer & $O(EB n^2d^2)$ & $O(n)$ & E epochs, B batches \\
