...
| Value | 0.127 | 0.45 |
	...
	extbf{Key Finding}: Commodity factors decay much faster (λ~0.15 vs. equity λ~0.07). Likely due to lower liquidity and tighter convergence.
...
4. 	extbf{Model stationarity}: Parameters may drift over time (we assume stable λ)
