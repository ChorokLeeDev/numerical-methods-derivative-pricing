...
Our work unites these three areas around a core principle: \textit{domain structure matters}. Financial markets are not generic data distributions; they have specific structure (regimes, crowding dynamics, tail risk mechanisms). Effective ML in finance must respect and leverage this structure.
...
\begin{itemize}
  \item Use game theory to understand \textit{why} crowding matters and \textit{how} it works mechanistically
