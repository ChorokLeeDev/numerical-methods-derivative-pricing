# Appendix E: Algorithm Pseudocode and Implementation Details
...
### Algorithm E.1: Hyperbolic Decay Model Fitting

**Purpose**: Estimate decay parameters $K$ and $\lambda$ for each factor given empirical return data.
...
## E.2 Temporal-MMD: Regime-Conditional Domain Adaptation

### Algorithm E.2: Temporal-MMD Training

**Purpose**: Learn domain-invariant representations that transfer across markets while respecting regime structure.
...
### Algorithm E.3: CW-ACI Prediction Set Construction
...
### Algorithm E.4: Batch Prediction Set Construction (Multiple Test Points)
